...
import com.noteshareapp.adpters.OurNoteListAdapter;
...
public class MainActivity extends DrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextsearchNote.setTypeface(faceMedium);
        ...
        editTextsearchNote.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (folderIdforNotes == null || folderIdforNotes.equals("-1") || folderIdforNotes == "") {
                    ...
                    //find note
                    sortallnotes = Note.findWithQuery(Note.class, "Select * from Note where creationtime != 0 AND folder ='0' AND title LIKE ?", "%" + editTextsearchNote.getText().toString() + "%");
                } else {
                ...
                textViewheaderTitle.setTypeface(faceBold);
            }
    ...
    public void setFonts() {
        faceBold = Typeface.createFromAsset(getAssets(), "fonts/AgendaBold.ttf");
        faceMedium = Typeface.createFromAsset(getAssets(), "fonts/Agenda-Medium.ttf");
    }
    ...
    void initlizeUIElement(View contentview) {
        ...
        TextView tvSortText = (TextView) findViewById(R.id.tvSortText);
        tvSortText.setTypeface(RegularFunctions.getAgendaMediumFont(this));

        textNoteView = (RelativeLayout) findViewById(R.id.textNoteView);

        TextView tvViewText = (TextView) findViewById(R.id.tvViewText);
        tvViewText.setTypeface(RegularFunctions.getAgendaMediumFont(this));
    ...
    public void showActionSheet(View v) {
        ...
        TextView tvView = (TextView) myDialog.findViewById(R.id.tvView);
        tvView.setTypeface(RegularFunctions.getAgendaMediumFont(this));
        ...
        layoutListTextView.setTypeface(RegularFunctions.getAgendaMediumFont(this));
        ...
        layoutDetailTextView.setTypeface(RegularFunctions.getAgendaMediumFont(this));
        ...
        layoutGridTextView.setTypeface(RegularFunctions.getAgendaMediumFont(this));
    ...
    public void showActionSheet_sort(View v) {
        ...
        TextView tvSort = (TextView) myDialog.findViewById(R.id.tvSort);
        tvSort.setTypeface(RegularFunctions.getAgendaMediumFont(this));
        ...
        layoutPintrestTextView.setTypeface(RegularFunctions.getAgendaMediumFont(this));
        ...
        layoutListTextViewReminderTime.setTypeface(RegularFunctions.getAgendaMediumFont(this));
        ...
        layoutListTextViewTimeBomb.setTypeface(RegularFunctions.getAgendaMediumFont(this));
